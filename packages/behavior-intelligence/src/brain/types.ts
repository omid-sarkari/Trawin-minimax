...
export interface NormalizedEvent {
  id: string | number
  timestamp: number
  type: 'insert' | 'delete' | 'modify' | 'paste' | 'other'
...
export interface BrainConfig {
  input: {
    useEditorEvents: boolean
    useCodingEvents: boolean
    useClipboardMarkers: boolean
  ...
  output: {
    writeBehaviorEvents: boolean
    writeCodeMetrics: boolean
    updateBehaviorState: boolean
  }
}